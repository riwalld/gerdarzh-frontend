export default {
    ...
    <div class="last-nouns">
        <div class="new-noon">
            ...
            <div class="new-noon-text">
                <h3>Paris</h3>
                <p>
                    <b>Description:</b> "Capitale des Parisii, initialement construite sur la rive gauche de la Seine,
                    puis nommée
    ...
    <div class="last-nouns">
        <div class="new-noon">
            <div class="new-noon-img">
                <a href="../images/rouen.jpg"><img src="../images/rouen.jpg" width="150" height="150" border-radius="10"
                        alt="Paris"></a>
            </div>
            <div class="new-noon-text">
                <h3>Rouen</h3>
                <p>
                    <b>Description:</b> "La ville a été fondée sur la rive droite de la Seine durant le règne
                    d’Auguste.",<br>
